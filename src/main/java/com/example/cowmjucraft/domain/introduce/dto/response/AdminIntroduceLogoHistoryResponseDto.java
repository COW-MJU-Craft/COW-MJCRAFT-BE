...
@Schema(description = "로고 히스토리 관리자 응답")
public record AdminIntroduceLogoHistoryResponseDto(
        @Schema(description = "연도", example = "2024")
        String year,

        @Schema(description = "이미지 S3 object key", example = "uploads/introduce/sections/uuid-logo-2024.png", nullable = true)
        String imageKey,
