...
public enum OrderErrorType implements ErrorCode {
    ...
    REQUIRED_OPTION_MISSING(400, "필수 옵션을 선택해야 합니다."),
    OPTION_NOT_BELONG_TO_ITEM(400, "해당 상품의 옵션이 아닙니다."),
    DUPLICATE_OPTION_GROUP_SELECTION(400, "같은 옵션 그룹에서는 하나만 선택할 수 있습니다."),
